...
@media (min-width: 576px) {
  ...
  .navbar-expand-sm .offcanvas .offcanvas-:host {
    display: flex;
    flex-grow: 0;
    padding: 0;
    overflow-y: visible;
...
@media (min-width: 768px) {
  ...
  .navbar-expand-md .offcanvas .offcanvas-:host {
    display: flex;
    flex-grow: 0;
    padding: 0;
    overflow-y: visible;
...
@media (min-width: 992px) {
  ...
  .navbar-expand-lg .offcanvas .offcanvas-:host {
    display: flex;
    flex-grow: 0;
    padding: 0;
    overflow-y: visible;
...
@media (min-width: 1200px) {
  ...
  .navbar-expand-xl .offcanvas .offcanvas-:host {
    display: flex;
    flex-grow: 0;
    padding: 0;
    overflow-y: visible;
...
@media (min-width: 1400px) {
  ...
  .navbar-expand-xxl .offcanvas .offcanvas-:host {
    display: flex;
    flex-grow: 0;
    padding: 0;
    overflow-y: visible;
...
.navbar-expand .offcanvas .offcanvas-:host {
  display: flex;
  flex-grow: 0;
  padding: 0;
  overflow-y: visible;
...
@media (max-width: 575.98px) {
  ...
  .modal-fullscreen-sm-down .modal-:host {
    overflow-y: auto;
  }
}
@media (max-width: 767.98px) {
  ...
  .modal-fullscreen-md-down .modal-:host {
    overflow-y: auto;
  }
}
@media (max-width: 991.98px) {
  ...
  .modal-fullscreen-lg-down .modal-:host {
    overflow-y: auto;
  }
}
@media (max-width: 1199.98px) {
  ...
  .modal-fullscreen-xl-down .modal-:host {
    overflow-y: auto;
  }
}
@media (max-width: 1399.98px) {
  ...
  .modal-fullscreen-xxl-down .modal-:host {
    overflow-y: auto;
  }
}
.tooltip {
